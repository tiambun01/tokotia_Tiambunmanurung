! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).sa = e() }(this, (function() {
    "use strict";
    const t = new Map,
        e = {set(e, i, n) {
                t.has(e) || t.set(e, new Map);
                const s = t.get(e);
                s.has(i) || 0 === s.size ? s.set(i, n) : console.error(`doesn't allow more than one instance per element. Bound instance: ${Array.from(s.keys())[0]}.`)
            },
    ...
    const vi = Object.freeze(Object.defineProperty({ __proto__: null, afterMain: ae, afterRead: se, afterWrite: he, applyStyles: _e, arrow: je, auto: Kt, basePlacements: Qt, beforeMain: oe, beforeRead: ie, beforeWrite: le, bottom: Rt, clippingParents: Ut, computeStyles: Be, createPopper: bi, createPopperBase: gi, createPopperLite: _i, detectOverflow: ii, end: Yt, eventListeners: Re, flip: si, hide: ai, left: Vt, main: re, modifierPhases: de, offset: li, placements: ee, popper: Jt, popperGenerator: mi, popperOffsets: ci, preventOverflow: hi, read: ne, reference: Zt, right: qt, start: Xt, top: zt, variationPlacements: te, viewport: Gt, write: ce }, Symbol.toStringTag, { value: "Module" })),
        ...
        Di = `keyup${wi}${Ai}`,
        $i = "show",
        Ii = '[data-bs-toggle="pilihanmenu"]:not(.disabled):not(:disabled)',
        Ni = `${Ii}.${$i}`,
        Pi = ".pilihanmenu-menu",
    ...
    class qi extends W {
        ...
        _createPopper() {
            if (void 0 === vi) throw new TypeError("pilihanmenus require Popper (https://popper.js.org)");
            let t = this._element;
        ...
        _getPlacement() { const t = this._parent; if (t.classList.contains("dropend")) return Wi; if (t.classList.contains("dropstart")) return Bi; if (t.classList.contains("dropup-center")) return "top"; if (t.classList.contains("pilihanmenu-center")) return "bottom"; const e = "end" === getComputedStyle(this._menu).getPropertyValue("--bs-position").trim(); return t.classList.contains("dropup") ? e ? ji : Mi : e ? Hi : Fi }
        ...
        _selectMenuItem({ key: t, target: e }) {
            const i = z.find(".pilihanmenu-menu .pilihanmenu-item:not(.disabled):not(:disabled)", this._menu).filter((t => a(t)));
    ...
    class cs extends W {
        constructor(t, e) {
            if (void 0 === vi) throw new TypeError("tooltips require Popper (https://popper.js.org)");
    ...
    class Es extends W {
        ...
        _activateParents(t) {
            if (t.classList.contains("pilihanmenu-item")) z.findOne(".pilihanmenu-toggle", t.closest(".pilihanmenu")).classList.add(_s);
            else
    ...
    class Ks extends W {
        ...
        _activate(t, e) { t && (t.classList.add(Fs), this._activate(z.getElementFromSelector(t)), this._queueCallback((() => { "tab" === t.getAttribute("role") ? (t.removeAttribute("tabindex"), t.setAttribute("aria-selected", !0), this._togglepilihanmenu(t, !0), N.trigger(t, ks, { relatedTarget: e })) : t.classList.add(Ws) }), t, t.classList.contains(Hs))) }
        _deactivate(t, e) { t && (t.classList.remove(Fs), t.blur(), this._deactivate(z.getElementFromSelector(t)), this._queueCallback((() => { "tab" === t.getAttribute("role") ? (t.setAttribute("aria-selected", !1), t.setAttribute("tabindex", "-1"), this._togglepilihanmenu(t, !1), N.trigger(t, Os, { relatedTarget: e })) : t.classList.remove(Ws) }), t, t.classList.contains(Hs))) }
        _keydown(t) {
        ...
        _togglepilihanmenu(t, e) {
            const i = this._getOuterElement(t);
            if (!i.classList.contains("pilihanmenu")) return;
            const n = (t, n) => {
                const s = z.findOne(t, i);
                s && s.classList.toggle(n, e)
            };
            n(Bs, Fs), n(".pilihanmenu-menu", Ws), i.setAttribute("aria-expanded", e)
        }
    ...
    return R(ao), m(ao), { Alert: Q, Button: Y, Carousel: xt, Collapse: Bt, pilihanmenu: qi, Modal: On, Offcanvas: qn, Popover: us, ScrollSpy: Es, Tab: Ks, Toast: ao, Tooltip: cs }
}));